        ...
        {detailsPage ?
          ...
          <>
            ...
            <Button
              ...
              style={{ display: enrollNowDialogOpen ? 'none' : 'inline-flex' }}
            >
              Enroll Now
            </Button>
          </>
    ...
    return (
      <>{isSaving && <div className={classes.SavingProgress}> <CircularProgress style={{ zIndex: '99999' }} /></div>}
        <div
          ...
          style={{ display: enrollNowDialogOpen ? 'block' : 'none' }}
        >
          <DialogTitle
            id="enroll-now"
          ...
          >
            ...
            <CloseIcon style={{ position: 'absolute', top: '23px', right: '2px', color: 'grey', cursor: 'pointer' }} onClick={handleEnrollNowDialogClose} />
          </DialogTitle>
